Parse.Cloud.define("getPlayerDetail", function(request, response) 
{
  var selectedUserDetailId = request.params.selectedUserDetailId;
  var selectedPlayerDetailId = request.params.selectedPlayerDetailId;
  var playerDirectory = request.params.playerDirectory;
  ...
  var venueName = '';
  var playerDetail = Parse.Object.extend("playerDetail");
  var queryPlayerDetail = new Parse.Query(playerDetail);
  queryPlayerDetail.find
    ({
        success: function(results)                              
        {              
          //var venueObjectId = results[0].id;   
